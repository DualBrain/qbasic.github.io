...
LBOUND, [LCASE$](LCASE$), [LEFT$](LEFT$), [LEN](LEN), [LET](LET), LINE, LINE INPUT, LINE INPUT#, LOC, LOCATE, LOCK, LOF, [LOG](LOG), LONG, LOOP, LPOS, LPRINT, LPRINT USING, LSET, [LTRIM$](LTRIM$)
