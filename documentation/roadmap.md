...
[ASC](ASC), [CHR$](CHR$), [INSTR](INSTR), [LCASE$](LCASE$), LEFT$, [LEN](LEN), [MID$](MID$), [MID$ (Statement)](MID$-Statement), RIGHT$, [SPACE$](SPACE$), [STR$](STR$), [STRING$](STRING$), [UCASE$](UCASE$), [VAL](VAL)
...
[ABS](ABS), [ATN](ATN), CDBL, CINT, CLNG, [COS](COS), CSNG, [EXP](EXP), [FIX](FIX), [INT](INT), [LOG](LOG), RANDOMIZE, RND, [SGN](SGN), [SIN](SIN), [SQR](SQR), [TAN](TAN)
...
CIRCLE, [COLOR](COLOR), DRAW, GET, LINE, PAINT, PALETTE, PCOPY, PMAP, POINT, PRESET, PSET, PUT, SCREEN, VIEW, WINDOW
...
CALL, CALL ABSOLUTE, CASE, CDBL, CHAIN, [CHDIR](CHDIR), [CHR$](CHR$), CINT, CIRCLE, [CLEAR](CLEAR), CLNG, CLOSE, [CLS](CLS), [COLOR](COLOR), COM(n), COMMON, [CONST](CONST), [COS](COS), CSNG, CSRLIN, CVD, CVDMBF, CVI, CVL, CVS, CVSMBF
...
FIELD, FILEATTR, FILES, FIX, [FOR...NEXT](FOR...NEXT), FRE, FREEFILE, [FUNCTION](FUNCTION)
